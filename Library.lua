...
local BaseURL = "https://raw.githubusercontent.com/denplanewalker/Ilovetadc/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    TransparencyTexture = {
        RobloxId = 139785960036434,
        Path = "Ilovetadc/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "Ilovetadc/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "Ilovetadc/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "Ilovetadc/assets/CheckIcon.png",
...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("Ilovetadc/custom_assets/%s", AssetName),
            URL = URL,
