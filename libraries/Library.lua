...
local BaseURL = "https://raw.githubusercontent.com/deividcomsono/libraries/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    TransparencyTexture = {
        RobloxId = 139785960036434,
        Path = "libraries/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "libraries/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "libraries/assets/LoadingIcon.png",
    ...
    CheckIcon = {
        ...
        Path = "libraries/assets/CheckIcon.png",
...
do
    ...
    function CustomImageManager.AddAsset(
        ...
        CustomImageManagerAssets[AssetName] = {
            ...
            Path = string.format("libraries/custom_assets/%s", AssetName),
            URL = URL,
